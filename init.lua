...
vim.o.shiftwidth = 4 --Number of spaces used for each indentation step
...
-- Disable progressive keyboard enhancement protocol to fix Alacritty double inputs
...
require('lazy').setup({
...

  {
    ...
    ft = { 'http', 'rest' },
    opts = {
      default_env = 'dev', -- set your default environment
      env_file = '.env.json', -- environment file path
      global_keymaps = true,
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- changed grd to gd -> makes more sense
